INSERT INTO `db_online_fitness`.`user` (`username`, `password`, `first_name`, `last_name`, `city`, `email`, `activated`, `type`) VALUES ('user1', '0a041b9462caa4a31bac3567e0b6e6fd9100787db2ab433d96f6d178cabfce90', 'Danilo', 'V', 'Banja Luka', 'danilo.vrancic@student.etf.unibl.org', '1', '1');
